...
<div id="login" class="hvr-glow">
    ...
    <form action="{{ route('auth.logUser') }}" method="POST" id="loginForm">
        ...
        <div class="login_Signup_Area" >
            ...
            <input placeholder="Email" type="email" name="emaillogin" id="emaillogin" class="form-control" style="background: url('visitor/images/general/username.png') no-repeat left center; padding-left:40px;">
            <!--passwordlog-->
            </div>
            <div class="form-group">
            <input placeholder="Password" type="password" name="passwordlogin" id="passwordlogin" class="form-control" style="background: url('visitor/images/general/key.png') no-repeat left center; padding-left:40px;">
            <!--loginButton-->
            </div>
